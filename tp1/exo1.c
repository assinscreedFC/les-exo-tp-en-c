...
int main()
{
    FILE *fichier_donnees = fopen("donnees.csv", "w");
    clock_t debut, fin;
    ...
    do
    {
        ...
        case 7:
            ...
            fprintf(fichier_donnees, "Taille du tableau,Selection Sort,Insertion Sort,Merge Sort,Quick Sort,Bubble Sort\n");

            for (int n = 10; n <= 70000; n *= 10)
        ...
        printf("\ntabppuyez sur n'importe quelle touche pour continuer...");
        system("pause");
    } while (choix != 0);

    /*  tri_parselection(tab1);
        tri_parinsertion(tab2);
        tri_fusion(tab3, 0, taille - 1);
        tri_rapide(tab4, 0, taille);
